...
export type DeveloperSendScopeStatus =
  (typeof DEVELOPER_SEND_SCOPE_STATUSES)[number];

export function normalizeDeveloperSendScopeStatus(
  value: string | null | undefined
): DeveloperSendScopeStatus {
  return DEVELOPER_SEND_SCOPE_STATUSES.includes(
...
export function classifyDeveloperSendScopeRequest(
  expectedMonthlySendVolume: number
) {
  return expectedMonthlySendVolume <=
