...
## Administrator Automation Observability UX — 31 July 2026

This release adds administrator-only Activity Trend export-series filtering, a more prominent workflow-drift failure alert, and accessible interactive Automation Health chart tooltips. Pull request review identified two valid alert refinements: the decorative pulsing marker now remains hidden from assistive technology, and its timestamp formatter uses the resolved interface locale. Both fixes were applied to managed source, covered by focused contracts, checkpointed, and pushed as an exact-tree replacement before merge.

| Release evidence                  | Verified result                                                                                                                                                                            |
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Managed implementation checkpoint | `9fc29aabe4ec0d9761f1a7b69c716289f9241000`                                                                                                                                                 |
| Exact implementation tree         | `96b5d026639f97cb58e3af8c9e96c2e89e8d7241`                                                                                                                                                 |
| Managed evidence-only checkpoint  | `a34fbc34eb50ac1537bd9b19f1eda9a3211a7f58` (managed-project commit; not a public GitHub commit)                                                                                            |
| Evidence-only target tree         | `667d08b53fcb474191dfa746481f12050d8a71d9`                                                                                                                                                 |
| Protected release pull request    | [PR #65](https://github.com/SteveKinzey/getphame/pull/65)                                                                                                                                  |
| Evidence closeout pull request    | [PR #66](https://github.com/SteveKinzey/getphame/pull/66)                                                                                                                                  |
| Final reviewed release head       | `c548403861e4fc8e763b43493e3b7b18bc795a28`                                                                                                                                                 |
| Protected `main` merge commit     | `0a4b22e5db994a603239e9d151d40398a4eb1ea0`                                                                                                                                                 |
| Replacement-head Quality Gates    | [Push run 30662831831](https://github.com/SteveKinzey/getphame/actions/runs/30662831831) and [PR run 30662836538](https://github.com/SteveKinzey/getphame/actions/runs/30662836538) passed |
| Replacement-head recovery check   | [Run 30662836744](https://github.com/SteveKinzey/getphame/actions/runs/30662836744) passed                                                                                                 |
| Protected-main Quality Gate       | [Run 30663102330](https://github.com/SteveKinzey/getphame/actions/runs/30663102330) passed                                                                                                 |
| Protected-main recovery check     | [Run 30663102830](https://github.com/SteveKinzey/getphame/actions/runs/30663102830) passed                                                                                                 |

The full implementation gate passed 40 focused tests. After pull request review identified the two alert refinements, the replacement candidate reran a 20-test directly affected subset plus strict TypeScript, 151 full-suite files with 893 passing tests and 7 explicit integration skips, an OSV audit across 703 production package versions, client and server production builds, targeted formatting, whitespace validation, and an added-line credential-pattern scan. All review conversations were resolved only after the fixes reached the reviewed head. The pull request reached a clean protected state and merged normally without administrator bypass or force-push; its release branch was deleted afterward.

The final reviewed head is an ancestor of protected `main`. The managed checkpoint, reviewed release head, merge commit, and remote protected-main head all resolve to exact tree `96b5d026639f97cb58e3af8c9e96c2e89e8d7241`. The public no-store readiness endpoint returned HTTP 200 with `{"ok":true,"status":"ready"}` on `getphame.app`, `www.getphame.app`, `getphame.manus.space`, and `revrocket-j5ynazte.manus.space` after deployment.
