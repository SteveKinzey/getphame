...
const directKeyFallbackResources: Record<string, ResourceRecord> = {
  en: {
    ...
    onboardingWizard: {
      ...
      tour: { skip: "Skip Tour", show: "Show tips", skipTooltip: "Hide onboarding tips on this device", showTooltip: "Show onboarding tips again", skipSuccess: "Onboarding tips hidden. You can show them again at any time.", saveError: "We couldn't save your onboarding tips preference." },
    },
  ...
  "zh-CN": {
    ...
    onboardingWizard: {
      ...
      tour: { skip: "跳过导览", show: "显示提示", skipTooltip: "在此设备上隐藏设置提示", showTooltip: "再次显示设置提示", skipSuccess: "已隐藏设置提示。您可以随时再次显示它们。", saveError: "无法保存您的设置提示偏好。" },
    },
  ...
  "zh-TW": {
    ...
    onboardingWizard: {
      ...
      tour: { skip: "略過導覽", show: "顯示提示", skipTooltip: "在此裝置隱藏設定提示", showTooltip: "再次顯示設定提示", skipSuccess: "已隱藏設定提示。您可隨時再次顯示。", saveError: "無法儲存您的設定提示偏好。" },
    },
