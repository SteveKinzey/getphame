...
const directKeyFallbackResources: Record<string, ResourceRecord> = {
  ...
  "zh-TW": {
    ...
    apiRecovery: { reconnecting: "正在重新連線…", preparing: "正在準備您的工作區…", preparingDescription: "服務準備就緒後，我們會自動重新連線。", unavailableTitle: "我們正在重新連線 Get Phame。", unavailableDescription: "服務所需時間比預期稍長。您的工作很安全；準備好後請再試一次。", offlineTitle: "您目前處於離線狀態。", offlineDescription: "請檢查 Wi-Fi 或行動數據，然後重試。您的工作會安全保留在此裝置上。", offlineStepOne: "開啟 Wi-Fi 或行動數據。", offlineStepTwo: "回到這裡並點選「重試」。", retry: "重試", retryNow: "立即重試", retrying: "正在重試…", reconnected: "您已恢復連線。", reconnectedDescription: "Get Phame 已連線，可以使用。" },
