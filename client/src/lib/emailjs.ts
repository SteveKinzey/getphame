...
export async function sendTestEmail(params: {
  ...
  try {
    ...
    const templateParams = {
      ...
      message: `This is a test email from Phame. Your EmailJS integration is working correctly! 🚀 When you send a real review request, your customers will receive a message like this with your actual Google Review link.`,
    };
...
export async function sendReviewSMS(params: {
  ...
  console.log(`[Phame SMS Demo] To: ${customerPhone}\nMessage: ${message}`);
