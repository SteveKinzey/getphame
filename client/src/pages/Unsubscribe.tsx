...
export default function UnsubscribePage() {
  ...
  useEffect(() => {
    ...
    if (t) {
      ...
      setStatus("error");
      setErrorMsg(
        "No unsubscribe token found in the link. Please use the link from your email."
      );
    }
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 pt-16 pb-40 rr-bg-cream-warm">
      {/* Card */}
      <div
      ...
      >
        {/* Navy header */}
        <div className="px-8 py-6 text-center rr-bg-navy">
          <p className="text-base font-bold tracking-widest uppercase mb-1 rr-text-gold">
            Get Phame
          </p>
          <h1
        ...
        <div className="px-8 py-8 text-center">
          ...
          {status === "success" && (
            <div className="flex flex-col items-center gap-4">
              ...
              <div>
                <p className="text-lg font-bold mb-1 rr-text-navy">
                  You've been unsubscribed
                </p>
                <p className="text-base font-semibold rr-text-navy-mid">
                  You won't receive any more review request emails. If this was
                  a mistake, please contact the business directly.
                </p>
              </div>
            </div>
          )}
