    ...
    <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        ...
        <label className="text-sm font-semibold text-slate-700">
          ...
          <select value={queueStatus} onChange={event => setQueueStatus(event.target.value as DisposableQueueStatus)} className="min-h-11 rounded-xl border border-slate-300 bg-white px-3 text-sm focus:border-[#C9A84C] focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/30" name="rr-pages-admin-signup-risk-queue-status-123">
