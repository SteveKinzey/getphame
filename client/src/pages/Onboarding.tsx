          ...
          >
            <div>
              ...
              <p className="text-xl font-bold leading-relaxed text-white/90">
                ...
                Your customers see it come from you — not a generic sender.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4">
              {[
                {
                  icon: Shield,
                  text: "AES-256 encrypted credentials — your data stays safe",
                },
                {
                  icon: Lock,
                  text: "Sends from the email account you connect",
                },
                {
                  icon: Zap,
                  text: "Guided setup — no technical skills needed",
                },
              ].map(item => (
                <div key={item.text} className="flex items-start gap-3">
                  ...
                  <p className="text-base font-bold leading-relaxed pt-2 text-white/90">
                    {item.text}
                  </p>
                </div>
              ))}
          ...
          >
            <div className="relative">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(255,184,0,0.15), transparent, rgba(255,184,0,0.08))",
                }}
              />

              {/* Card */}
              <div
                className="relative rounded-2xl p-8 md:p-10 shadow-2xl"
                style={{
              ...
              >
                ...
                <div className="lg:hidden text-center mb-8">
                  ...
                  <p className="text-base font-bold mt-3 leading-relaxed text-white/80">
                    Send personalized review requests from your own email
                    account.
                  </p>
                </div>
                      ...
                      {appleLoginEnabled && (
                        ...
                        >
                          <svg
                            ...
                            fill="white"
                          >
                            <path d="M788.1 340.9c-5.8 4.5-108.2 62.2-108.2 190.5 0 148.4 130.3 200.9 134.2 202.2-.6 3.2-20.7 71.9-68.7 141.9-42.8 61.6-87.5 123.1-155.5 123.1s-85.5-39.5-164-39.5c-76 0-103.7 40.8-165.9 40.8s-105-57.8-155.5-127.4C46 376.7 0 248.1 0 125.8 0 56.3 25.6 0 75.4 0c52.1 0 84.1 34.1 116.6 34.1 31.1 0 79.3-36.3 134.2-36.3 26.5 0 98.1 2.6 150.2 76.2zm-220-176.4c28.3-35.1 49.3-84.4 49.3-133.7 0-6.5-.6-13-1.9-18.1-46.9 1.9-101.9 32.2-135.3 71.9-26.5 29.9-50.6 79.2-50.6 129.2 0 7.1 1.3 14.3 1.9 16.5 3.2.6 8.4 1.3 13.6 1.3 42.2 0 95.2-28.3 123-66.1z" />
                          </svg>
                ...
                <p className="mt-4 text-center text-sm font-bold text-white/70">
                  ...
                  <a
                    href={appendAuthReturnPath("/login", returnPath)}
