...
const COMPARISON_ROWS: { feature: string; free: string | boolean; pro: string | boolean; lifetime: string | boolean }[] = [
  { feature: "Review requests",            free: "10 free, then 5/30 days", pro: "Unlimited", lifetime: "Unlimited" },
  { feature: "Bulk send (contacts/Woo)",   free: false,      pro: true,         lifetime: true },
  { feature: "Follow-up reminders",        free: false,      pro: true,         lifetime: true },
  { feature: "WooCommerce sync",           free: false,      pro: true,         lifetime: true },
  { feature: "CSV export",                 free: false,      pro: true,         lifetime: true },
  ...
  return (
    <div className="min-h-screen pb-40 rr-bg-navy">
      ...
      <div className="px-4 flex flex-col gap-4">
        ...
        {/* ── Free tier rolling quota explainer ─────────────────────────────── */}
        <div
          className="rounded-2xl p-4 mb-1"
          style={{ background: "oklch(0.18 0.07 260)", border: "1px solid rgba(255,255,255,0.10)" }}
        >
          <p className="text-xs font-black rr-text-gold uppercase tracking-widest mb-2">How the Free Plan Works</p>
          <div className="flex flex-col gap-2">
            <div className="flex items-start gap-2">
              <span className="text-base">🎁</span>
              <p className="text-xs text-white font-semibold leading-relaxed">
                <strong>First 10 sends are free</strong> — no credit card required. Use them however you like.
              </p>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-base">🔄</span>
              <p className="text-xs text-white font-semibold leading-relaxed">
                <strong>After your 10th send</strong>, a 30-day window starts. You get 5 sends per window.
              </p>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-base">⏳</span>
              <p className="text-xs text-white font-semibold leading-relaxed">
                <strong>Sends don't accumulate.</strong> If you use 2 of 5 this window, you still only get 5 next window — not 8.
              </p>
            </div>
            <div className="flex items-start gap-2">
              <span className="text-base">⚡</span>
              <p className="text-xs font-bold" style={{ color: "oklch(0.80 0.18 80)" }}>
                Upgrade to Pro for unlimited sends, bulk send, WooCommerce sync, and follow-up reminders.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {[
            ...
            },
            {
              ...
              a: t("upgradeFaq.a2", "You keep access until the end of your current billing period. After that your account reverts to the free tier: 10 free sends to start, then 5 sends every 30 days from the date your 10th send was made. Free sends do not accumulate — unused sends expire. Your contacts and history are never deleted."),
            },
            {
