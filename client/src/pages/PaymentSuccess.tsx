    ...
    lifetime: [
      {
        ...
        text: "Unlimited review requests — forever",
      },
...
const HEADING_BY_TIER: Record<
  string,
  { top: string; highlight: string; sub: string }
> = {
  pro: {
    top: "You're",
    highlight: "Pro!",
...
const NEXT_STEPS = [
  {
    ...
    description:
      "Add your business name, sender details, and review destination.",
    route: "/settings",
  ...
  },
  {
    ...
    description:
      "Start from a proven message, then personalize the follow-up experience.",
    route: "/templates",
  ...
  },
  {
    ...
    description:
      "Invite a recent customer and turn the completed job into a review opportunity.",
    route: "/send",
...
export default function PaymentSuccessPage() {
  ...
  const tier = (stripeReturnTier ?? profile?.tier ?? "pro") as
    | "pro"
    | "annual"
    | "lifetime";
  ...
  useEffect(() => {
    ...
    toast.success(
      t("paymentSuccess.confirmedToast", {
        defaultValue: "Payment confirmed. Your Get Phame access is active.",
      })
    );
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-5 pb-40 pt-14 relative overflow-hidden rr-bg-navy">
      ...
      <div className="relative mb-6 flex flex-col items-center">
        <div className="w-24 h-24 rounded-full flex items-center justify-center mb-4 shadow-2xl rr-bg-gold">
          {tier === "lifetime" ? (
        ...
        <div
          className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full flex items-center justify-center border-2 rr-bg-green"
          style={{ borderColor: "oklch(0.22 0.09 260)" }}
        >
      ...
      {/* Heading */}
      <h1 className="text-4xl font-black text-center mb-2 leading-tight text-white">
        {heading.top} <span className="rr-text-gold">{heading.highlight}</span>
      </h1>
      <p
        className="text-center text-xl font-black mb-1 text-white"
        role="status"
        data-testid="stripe-success-confirmation"
      >
        {t("paymentSuccess.confirmed", { defaultValue: "Payment confirmed." })}{" "}
        {heading.sub}
      </p>
      <p className="max-w-xl text-center text-base font-bold mb-8 text-white/85">
        {t("paymentSuccess.thankYou", {
          defaultValue:
            "Thank you for investing in your reputation system. Your next three actions will turn that upgrade into visible customer trust.",
        })}
      </p>
      ...
      <div className="w-full max-w-4xl grid gap-4 lg:grid-cols-[0.88fr_1.12fr] mb-6">
        ...
        <section className="rounded-2xl p-5 rr-bg-navy-mid">
          <p className="text-base font-black tracking-widest uppercase mb-4 rr-text-gold">
            {cardTitle}
          </p>
        ...
        >
          <div className="flex items-center justify-between gap-3 mb-4">
            <div>
              ...
              <p className="mt-1 text-sm leading-5 text-white/75">
                A clear path from activation to your first review request.
              </p>
            </div>
          ...
          <ol className="space-y-3">
            {NEXT_STEPS.map(step => (
              ...
              >
                <span className="font-mono text-xs font-black rr-text-gold">
                  {step.number}
                </span>
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 text-white">
                    <span className="rr-text-gold">{step.icon}</span>
                  ...
                  <button
                    ...
                    className="mt-2 text-xs font-black rr-text-gold flex items-center gap-1"
                  >
      ...
      <div className="w-full max-w-4xl grid gap-3 sm:grid-cols-2">
        ...
        <button
          ...
          style={{
            ...
            background: "oklch(0.28 0.07 260)",
          }}
        >
      ...
      <p className="text-center text-base font-bold mt-2 text-white/80">
        {t("paymentSuccess.closingThankYou", {
          defaultValue: "Thank you for choosing Get Phame.",
        })}
      </p>
    </div>
  );
