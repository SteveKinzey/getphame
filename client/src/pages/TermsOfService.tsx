    ...
    <div className="min-h-screen pb-40 rr-bg-cream-warm">
      ...
      <div className="px-5 py-6 max-w-2xl mx-auto space-y-7 text-sm leading-relaxed pb-40" style={BODY}>
        ...
        <section>
          ...
          <p className="mb-3">
            By creating an account or otherwise accessing or using the ReviewLink web application (the "Service"), you agree to be legally bound by these Terms of Service ("Terms") and our Privacy Policy, which is incorporated herein by reference. If you are using the Service on behalf of a business or other legal entity, you represent that you have authority to bind that entity to these Terms, and "you" refers to that entity.
          </p>
          <p>
        ...
        <section>
          ...
          <p className="mb-3">
            ReviewLink is a software-as-a-service (SaaS) web application that enables small business owners to send personalised review request emails to their customers using their own connected email account (via SMTP). The Service provides tools for managing customer contacts, creating email templates, scheduling follow-up reminders, and viewing delivery analytics (open and click tracking).
          </p>
          <p>
        ...
        {/* 3. Eligibility */}
        <section>
          <h2 className={SH} style={SHS}>3. Eligibility and Account Registration</h2>
          <p className="mb-3">
        ...
        {/* 4. Acceptable Use */}
        <section>
          <h2 className={SH} style={SHS}>4. Acceptable Use Policy</h2>
          <p className="mb-3">
            You may use the Service only for lawful purposes and in accordance with these Terms. The following conduct is expressly prohibited:
          </p>

          <h3 className="font-bold mb-2 mt-3" style={SHS}>4.1 Prohibited Email Practices</h3>
          <p className="mb-2">
            You must not use the Service to send unsolicited commercial email (spam) to any person who has not had a genuine, prior business relationship with you. You must not use purchased, rented, scraped, or otherwise third-party-sourced email lists. You must not send emails to individuals who have previously opted out, unsubscribed, or asked not to be contacted. You must not send emails in volumes or frequencies that constitute harassment.
          </p>

          <h3 className="font-bold mb-2 mt-3" style={SHS}>4.2 Prohibited Technical Conduct</h3>
          <p className="mb-2">
            You must not attempt to gain unauthorised access to any part of the Service, its servers, databases, or related systems. You must not use automated scripts, bots, or other tools to circumvent the Service's rate limits or to send emails at volumes exceeding what you could reasonably send manually. You must not probe, scan, or test the vulnerability of any system or network associated with the Service. You must not introduce malicious code, viruses, or other harmful components into the Service.
          </p>

          <h3 className="font-bold mb-2 mt-3" style={SHS}>4.3 Prohibited Content and Conduct</h3>
          <p className="mb-2">
            You must not use the Service to harass, threaten, defame, or deceive any person. You must not impersonate any person or entity or misrepresent your affiliation with any person or entity. You must not use the Service to send content that is illegal, fraudulent, obscene, or that infringes the intellectual property rights of any third party. You must not use the Service in any manner that could damage, disable, overburden, or impair the Service or interfere with any other party's use of the Service.
          </p>

          <p className="mt-3">
            Violation of this Acceptable Use Policy may result in immediate suspension or termination of your account, and may be reported to relevant law enforcement authorities where required by law.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ReviewLink is not liable for any fines, penalties, regulatory actions, or damages arising from your failure to comply with applicable email laws. You agree to indemnify and hold ReviewLink harmless from any claims, losses, or expenses (including reasonable legal fees) arising from your violation of applicable anti-spam or data protection laws.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-3">
            By connecting your email account via SMTP, you authorise ReviewLink to send emails on your behalf using the credentials you provide. You represent that you are authorised to use the email account you connect and that doing so does not violate any terms of service of your email provider.
          </p>
          <p className="mb-3">
          ...
          <p>
            ReviewLink performs periodic automated health checks on your connected email account to verify that it remains reachable. You acknowledge that these checks involve a test connection to your mail server using your stored credentials. You may disable health checks by disconnecting your account.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mb-3">
            You are the data controller for all customer contact information (names, email addresses) that you upload to or generate within the Service. ReviewLink acts as a data processor on your behalf with respect to that customer data, processing it solely to provide the Service in accordance with your instructions.
          </p>
          <p className="mb-3">
        ...
        <section>
          ...
          <p className="mb-3">
            The Service, including its software, design, text, graphics, logos, and all other content created by ReviewLink, is owned by or licensed to ReviewLink and is protected by United States and international copyright, trademark, patent, trade secret, and other intellectual property laws. Nothing in these Terms grants you any right, title, or interest in the Service or its content beyond the limited licence to use the Service as described herein.
          </p>
          <p className="mb-3">
            You retain all ownership rights in the content you create using the Service, including email templates you write and customer data you upload. By using the Service, you grant ReviewLink a limited, non-exclusive, royalty-free licence to store, process, and transmit your content solely as necessary to provide the Service.
          </p>
          <p>
        ...
        {/* 10. Disclaimers */}
        <section>
          <h2 className={SH} style={SHS}>10. Disclaimer of Warranties</h2>
          <p className="mb-3">
            THE SERVICE IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO IMPLIED WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, AND TITLE. REVIEWLINK DOES NOT WARRANT THAT THE SERVICE WILL BE UNINTERRUPTED, ERROR-FREE, SECURE, OR FREE OF VIRUSES OR OTHER HARMFUL COMPONENTS.
          </p>
          <p className="mb-3">
            We make no guarantees regarding: (a) the deliverability of emails sent through the Service; (b) the number of reviews you will receive as a result of using the Service; (c) the accuracy or completeness of any analytics data; or (d) the continued availability of any third-party review platforms (Google, Yelp, TripAdvisor, etc.) to which you link.
          </p>
          <p>
        ...
        <section>
          <h2 className={SH} style={SHS}>11. Limitation of Liability</h2>
          <p className="mb-3">
          ...
          <p className="mb-3">
            <strong>Liability cap.</strong> In no event shall ReviewLink's total aggregate liability to you for all claims arising out of or relating to these Terms or the Service exceed the greater of: (a) the total amount you paid to ReviewLink in the twelve (12) months immediately preceding the event giving rise to the claim; or (b) one hundred US dollars (USD $100.00). This limitation applies regardless of the form of action, whether in contract, tort (including negligence), strict liability, or otherwise.
          </p>
          <p>
        ...
        <section>
          ...
          <p className="mb-2">
            <strong>Entire agreement.</strong> These Terms, together with the Privacy Policy, constitute the entire agreement between you and ReviewLink with respect to the Service and supersede all prior agreements, representations, and understandings.
          </p>
          <p className="mb-2">
          ...
          <p>
            <strong>Force majeure.</strong> ReviewLink shall not be liable for any failure or delay in performance resulting from causes beyond our reasonable control, including acts of God, natural disasters, war, terrorism, labour disputes, internet outages, or actions of third-party service providers.
          </p>
        </section>

        {/* 17. Contact */}
        <section>
          <h2 className={SH} style={SHS}>17. Contact Us</h2>
          <p className="mb-3">
