          ...
          <>
            ...
            <div className="rounded-2xl p-4" style={{ background: NAVY }}>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  {
                    label: "Free",
                    count: data.tierCounts.free,
                    color: "rgba(255,255,255,0.3)",
                  },
                  {
                    label: "Monthly Pro",
                    count: data.tierCounts.pro,
                    color: GOLD,
                  },
                  {
                    label: "Annual",
                    count: data.tierCounts.annual,
                    color: "oklch(0.70 0.15 160)",
                  },
                  {
                    label: "Lifetime",
                    count: data.tierCounts.lifetime,
            ...
            >
              <div>
                ...
                <p className="text-base font-bold text-white/80">
                  {data.recentCancels} cancellation
                  {data.recentCancels !== 1 ? "s" : ""} / {data.activeSubs}{" "}
                  active
                </p>
              </div>
              <span
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      color:
                        data.platformOpenRate >= 30
                          ? "oklch(0.70 0.18 145)"
                          : data.platformOpenRate >= 15
                            ? GOLD
                            : "#f87171",
                    }}
                  >
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      color:
                        data.platformClickRate >= 5
                          ? "oklch(0.70 0.18 145)"
                          : data.platformClickRate >= 2
                            ? GOLD
                            : "#f87171",
                    }}
                  >
            ...
            <div className="rounded-2xl p-4" style={{ background: NAVY }}>
              ...
              <p className="text-sm font-bold text-white/50">
                Reveals = users who tapped "Show PromptPay QR" on the upgrade
                page. Reveal→Paid = total paid users ÷ total reveals (all-time
                approximation).
              </p>
            </div>
