        ...
        <div className="container">
          <FadeUp className="text-center mb-8">
            <p className="text-sm font-semibold text-primary uppercase tracking-wider mb-3">
              {t("videoDemo.eyebrow", { defaultValue: "See it in action" })}
            </p>
            <h2 className="font-display font-bold text-2xl md:text-3xl text-white mb-2">
              {t("videoDemo.title", { defaultValue: "See How It Works" })}
            </h2>
            <p className="text-slate-300 font-medium">
              {t("videoDemo.subtitle", { defaultValue: "Watch a quick walkthrough — set up in under 2 minutes" })}
            </p>
          </FadeUp>
              ...
              >
                ...
                <div className="flex items-center gap-3 px-5 py-3.5 bg-[#0f1d32] border-t border-[#1e3050]">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-xs text-slate-400 font-medium">{t("videoDemo.videoSubtitle", { defaultValue: "Connect email · Import customers · Send requests · Track results" })}</p>
                  </div>
                  <div className="ml-auto shrink-0 text-xs font-medium text-primary group-hover:underline">
                    {t("videoDemo.watchNow", { defaultValue: "Watch now \u2192" })}
                  </div>
                </div>
              </button>
            </div>
