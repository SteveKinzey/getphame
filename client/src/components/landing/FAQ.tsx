...
export default function FAQ() {
  ...
  const faqs = [
  { question: t("landing.faq.q1", { defaultValue: "Will it look like spam?" }), answer: t("landing.faq.a1", { defaultValue: "No. Every email is sent directly from the email account you connect, not from a third-party bulk-sending server. Customers see the sender name, address, and signature you configure." }) },
  ...
  { question: t("landing.faq.q9", { defaultValue: "Do I need technical skills to connect my email?" }), answer: t("landing.faq.a9", { defaultValue: "No. For Gmail and Outlook, we provide step-by-step guides with screenshots. For custom SMTP, you'll need your server address, port, and credentials — your hosting provider can supply these." }) },
  ...
  { question: t("landing.faq.q11", { defaultValue: "How does WooCommerce sync work?" }), answer: t("landing.faq.a11", { defaultValue: "The WooCommerce connector is available only on paid plans. Paid users install the Get Phame WooCommerce plugin, enter their API key, and new customers are automatically imported after each completed order. You can set a delay (e.g., 7 days after purchase) before they appear in your send queue." }) },
  { question: t("landing.faq.q12", { defaultValue: "What does unlimited mean on the Pro plan?" }), answer: t("landing.faq.a12", { defaultValue: "Unlimited means Get Phame does not set a monthly cap on review requests for Pro plans. Your connected email provider's sending policies and limits still apply." }) },
];
  return (
