    ...
    <footer className="w-full border-t border-[#1e3050] bg-[oklch(0.09_0.025_250)]">
      <div className="container">
        <div className="flex flex-col gap-7 py-8 sm:py-10 md:flex-row md:items-center md:justify-between">
          <a href="/" className="flex min-h-[44px] items-center justify-center gap-2.5 rounded-md px-2 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A017] md:justify-start">
          ...
          <div aria-label={t("landing.footer.navigationLabel", { defaultValue: "Get Phame links" })} className="grid grid-cols-2 items-center justify-center gap-x-3 gap-y-1 text-center text-sm sm:flex sm:flex-wrap sm:gap-x-6 sm:gap-y-3 md:justify-end">
            <a
              href="/review-requests"
              className="inline-flex min-h-[44px] items-center justify-center rounded-md px-2 text-slate-200 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A017] font-medium"
            >
