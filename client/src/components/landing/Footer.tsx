        ...
        <div className="flex flex-col gap-7 py-8 sm:py-10 md:flex-row md:items-center md:justify-between">
          ...
          >
            ...
            <span className="font-display font-bold text-base">
              ...
              <span className="text-primary">PHAME</span>
            </span>
          </a>

          <div
            aria-label="Get Phame links"
            className="grid grid-cols-2 items-center justify-center gap-x-3 gap-y-1 text-center text-sm sm:flex sm:flex-wrap sm:gap-x-6 sm:gap-y-3 md:justify-end"
          >
            <a
            ...
            >
              {t("landing.footer.reviewRequests", {
            ...
            <a
              ...
              className="inline-flex min-h-10 items-center justify-center rounded-md px-2 text-slate-200 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A017] font-medium"
            >
              {t("landing.footer.emailCampaigns", {
            ...
            <a
              ...
              className="inline-flex min-h-10 items-center justify-center rounded-md px-2 text-slate-200 transition-colors hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#D4A017] font-medium"
            >
              {t("landing.footer.reputationManagement", {
                defaultValue: "Reputation Management",
              })}
            </a>
            <a
              href="/privacy-policy"
