  ...
  const tabs = [
    {
      ...
      icon: Monitor,
      title: t("landing.productShowcase.tabEmailTitle", { defaultValue: "Preview each request before sending" }),
      description: t("landing.productShowcase.tabEmailDescription", { defaultValue: "Each review request uses the connected email address, sender name, signature, and message you configure before sending." }),
      webp: EMAIL_PREVIEW_WEBP,
      png: EMAIL_PREVIEW_PNG,
      alt: t("landing.productShowcase.tabEmailAlt", { defaultValue: "Get Phame review-request email preview showing a customer name, business signature, and configured review destination" }),
    },
    {
      id: "import",
      label: t("landing.productShowcase.tabImportLabel", { defaultValue: "Sources review" }),
      icon: Upload,
      title: t("landing.productShowcase.tabImportTitle", { defaultValue: "Review contacts before import" }),
      description: t("landing.productShowcase.tabImportDescription", { defaultValue: "Upload a CSV or connect WooCommerce, confirm permission, and review valid, duplicate, and rejected rows. Importing contacts never sends a message." }),
      webp: CUSTOMER_IMPORT_WEBP,
      png: CUSTOMER_IMPORT_PNG,
      alt: t("landing.productShowcase.tabImportAlt", { defaultValue: "Get Phame Sources screen showing CSV upload, consent confirmation, and duplicate review" }),
    },
    {
      id: "tracking",
      label: t("landing.productShowcase.tabTrackingLabel", { defaultValue: "Request activity" }),
      icon: TrendingUp,
      ...
      alt: t("landing.productShowcase.tabTrackingAlt", { defaultValue: "Get Phame activity dashboard showing request sends, opens, clicks, reminders, and completion status" }),
    },
  ];
