...
const testimonials = [
  {
    quote:
      "I used to dread asking clients for reviews — it felt awkward and salesy. Get Phame sends the request from my own Gmail so it actually looks like I wrote it. I went from 12 Google reviews to 47 in six weeks.",
    name: "Sarah M.",
  ...
  {
    quote:
      "As an agency managing 12 client locations, the lifetime deal was a no-brainer. Each client gets their own review link and I send requests on their behalf. The ROI paid for itself in the first month.",
    name: "David K.",
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 mb-12">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              <p className="text-slate-300 leading-relaxed mb-6 text-sm md:text-[15px]">
                "{t.quote}"
              </p>
              {/* Result badge */}
