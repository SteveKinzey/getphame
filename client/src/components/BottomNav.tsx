...
export default function BottomNav() {
  ...
  const NAV_ITEMS = [
    ...
    },
    {
      ...
      compactLabel: t("nav.mobileDashboard", {
    ...
    },
    {
      ...
      compactLabel: t("nav.mobileSettings", {
        defaultValue: t("nav.settings"),
      }),
      Icon: Settings,
      ...
      ? [
          {
            ...
            compactLabel: t("nav.mobileAdmin", {
              defaultValue: t("nav.admin", { defaultValue: "Admin" }),
            }),
            Icon: ShieldCheck,
            containsPremiumFeatures: false,
          },
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          gridTemplateColumns: `repeat(${NAV_ITEMS.length + 1}, minmax(0, 1fr))`,
        }}
      >
        {NAV_ITEMS.map(
          ({ path, label, compactLabel, Icon, containsPremiumFeatures }) => {
            const isActive =
            ...
            >
              ...
              >
                <img
                  ...
                  alt={
                    accountProfile?.avatarUrl
                      ? t("profileMenu.avatarAlt", {
                          defaultValue: "Your profile photo",
                        })
                      : ""
                  }
            ...
            {user && (
              <>
                ...
                >
                  ...
                  {isFreePlan && (
                    <ProBadge variant="compact" size="sm" className="ml-auto" />
                  )}
                </DropdownMenuItem>
                <DropdownMenuItem
      ...
      <div className="rr-bg-gold px-4 pt-2 pb-1 pb-[calc(0.25rem+env(safe-area-inset-bottom))] sm:px-5">
        ...
        <div
          ...
          className="mx-auto mt-1 grid max-w-56 grid-cols-2 gap-1"
        >
          <button
