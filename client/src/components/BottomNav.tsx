...
import { Home, Send, BarChart2, Moon, Sun } from 'lucide-react';
...
export default function BottomNav() {
  ...
  const NAV_ITEMS = [
    ...
    { path: '/settings', label: t('nav.settings'), Icon: null },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="grid gap-0" style={{ gridTemplateColumns: 'repeat(6, 1fr)' }}>
                ...
                {path === '/settings' ? (
                  avatarUrl ? (
                    <img
                      ...
                      style={{
                        border: isActive ? '2px solid oklch(0.80 0.18 80)' : '2px solid oklch(0.50 0.05 260)',
                      }}
                    />
                  ) : (
                    <div
                      ...
                      style={{
                        background: isActive ? 'oklch(0.80 0.18 80 / 0.25)' : 'oklch(0.35 0.08 260)',
        ...
        {/* Language selector — 6th column */}
        <div className="flex flex-col items-center justify-center py-3 gap-1" style={{ minHeight: '60px' }}>
          <LanguageFlyout />
        </div>
      </div>
