...
export default function ProBadge({
  ...
  const s = sizes[size];
  const premiumLabel = t("premiumConversion.marker.label", {
    defaultValue: "Premium",
  });
  const containsPremiumLabel = t("premiumConversion.marker.contains", {
    defaultValue: "Contains premium features",
  });
