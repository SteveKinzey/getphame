...
- [ ] Save and auto-publish the validated checkpoint, synchronize the exact tree through a history-preserving protected Get Phame pull request, resolve required review, pass all protected checks, merge normally, and prove protected `main` tree parity.
