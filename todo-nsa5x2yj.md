...
- [ ] Validate the CI-only remediation, save and auto-publish its checkpoint, synchronize the exact tree through protected Get Phame `main`, and verify the authoritative quality run is green.
