...
- [ ] Save and auto-publish the validated checkpoint, then synchronize the exact tree through a history-preserving protected Get Phame pull request with required review, green checks, normal merge, and protected-main parity verification.
