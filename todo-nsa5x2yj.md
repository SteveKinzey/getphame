...
- [ ] Run TypeScript, full Vitest, dependency audit, production build, desktop and Pixel 7 browser gates; publish a checkpoint and verify Italian, French, tooltip, and analytics behavior on live Get Phame.
