...
- [x] Reconcile the GitHub-main and managed schema, shared constants, dependency graph, database helpers, router composition, and runtime exports until the merged tree has zero TypeScript errors.
