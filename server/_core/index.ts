        ...
        if (userId && customerId) {
          ...
          if (subscriptionId && mode === "subscription") {
            await db
              ...
              .onConflictDoUpdate({ target: stripeSubscriptions.userId, set: { stripeSubscriptionId: subscriptionId, status: "active" } });
          }
          ...
          if (mode === "payment" && newTier === "lifetime") {
            ...
            if (paymentIntentId) {
              await db
                ...
                .onConflictDoUpdate({ target: stripeSubscriptions.userId, set: { status: "lifetime" } });
            }
          }
