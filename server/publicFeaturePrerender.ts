...
const PUBLIC_FEATURES: Record<PublicFeatureRoute, PrerenderFeature> = {
  ...
  "/email-campaigns": {
    ...
    socialImage: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663507659115/uvvaVNerCoMHTwhX.webp",
  ...
  "/reputation-management": {
    ...
    socialImage: "https://files.manuscdn.com/user_upload_by_module/session_file/310519663507659115/vHMUvHplgLmsaIxk.webp",
