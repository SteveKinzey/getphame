...
const STATIC_COPY_SOURCES = {
  es: {
    storageKey: "static-copy/2026-07-28/getphame-static-copy-es.json",
    fileName: "getphame-static-copy-es.json",
  },
  fr: {
    storageKey: "static-copy/2026-07-28/getphame-static-copy-fr.json",
    fileName: "getphame-static-copy-fr.json",
  },
  it: {
    storageKey: "static-copy/2026-07-28/getphame-static-copy-it.json",
    fileName: "getphame-static-copy-it.json",
  },
  th: {
    storageKey: "static-copy/2026-07-28/getphame-static-copy-th.json",
    fileName: "getphame-static-copy-th.json",
  },
  "zh-CN": {
    storageKey: "static-copy/2026-07-28/getphame-static-copy-zh-CN.json",
    fileName: "getphame-static-copy-zh-CN.json",
  },
  "zh-TW": {
    storageKey: "static-copy/2026-07-28/getphame-static-copy-zh-TW.json",
