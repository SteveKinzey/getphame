...
const SPECS: CatalogSpec[] = [
  {
    label: "USD monthly",
    envName: "STRIPE_TEST_PRICE_ID_USD_MONTHLY",
    currency: "usd",
    unitAmount: 2_900,
    interval: "month",
  },
  {
    label: "USD annual",
    envName: "STRIPE_TEST_PRICE_ID_USD_ANNUAL",
    currency: "usd",
    unitAmount: 29_000,
    interval: "year",
  },
  {
    label: "USD lifetime",
    envName: "STRIPE_TEST_PRICE_ID_USD_LIFETIME",
    currency: "usd",
    unitAmount: 34_900,
    interval: null,
  },
  {
    label: "THB monthly",
    envName: "STRIPE_TEST_PRICE_ID_THB_MONTHLY",
    currency: "thb",
    unitAmount: 97_000,
    interval: "month",
  },
  {
    label: "THB annual",
    envName: "STRIPE_TEST_PRICE_ID_THB_ANNUAL",
    currency: "thb",
    unitAmount: 999_000,
    interval: "year",
  },
  {
    label: "THB lifetime",
    envName: "STRIPE_TEST_PRICE_ID_THB_LIFETIME",
    currency: "thb",
    unitAmount: 1_170_000,
    interval: null,
  },
];
