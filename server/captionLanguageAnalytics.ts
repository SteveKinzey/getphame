export const CAPTION_LANGUAGE_ANALYTICS_LANGUAGES = ["en", "es", "fr", "it", "de", "pt"] as const;

export type CaptionLanguageAnalyticsCode = (typeof CAPTION_LANGUAGE_ANALYTICS_LANGUAGES)[number];

export const CAPTION_LANGUAGE_ANALYTICS_SOURCE = "walkthrough_captions";
const CAPTION_LANGUAGE_EVENT_PREFIX = "/captions/language/";

export function toCaptionLanguageEventPage(language: CaptionLanguageAnalyticsCode): string {
  return `${CAPTION_LANGUAGE_EVENT_PREFIX}${language}`;
}

export function fromCaptionLanguageEventPage(page: string): CaptionLanguageAnalyticsCode | null {
  ...
  return CAPTION_LANGUAGE_ANALYTICS_LANGUAGES.includes(language as CaptionLanguageAnalyticsCode)
